...
export type UseMethod<Req = any, Res = any, App extends RouterInterface<App, Req, Res> = any> = (path: RouterPathOrHandler<Req, Res> | App, handler?: RouterHandler<Req, Res> | App, ...handlers: (RouterHandler<Req, Res> | App)[]) => any;
export type UseMethodParams<Req = any, Res = any, App extends RouterInterface<App, Req, Res> = any> = Parameters<UseMethod<Req, Res, App>>;
...
export interface RouterInterface<App extends RouterInterface<App, Req, Res>, Req, Res> {
    add(method: Method): (path: string | string[] | Handler<Req, Res>, handler?: RouterHandler<Req, Res> | undefined, ...handlers: RouterHandler<Req, Res>[]) => RouterInterface<App, Req, Res>;
 ...
 */
export declare const pushMiddleware: <Req = any, Res = any>(mw: Middleware[]) => ({ path, handler, method, handlers, type, regex: precompiledRegex, fullPaths }: MethodHandler<Req, Res> & {
    method?: Method;
 ...
 */
export declare class Router<App extends Router = any, Req = any, Res = any> implements RouterInterface<App, Req, Res> {
    ...
    constructor();
    add(method: Method): (...args: RouterMethodParams<Req, Res>) => this;
