 ...
 * @param res Response
 */
export declare const sendFile: <Request extends Req = Req, Response extends Res = Res>(req: Request, res: Response) => (path: string, opts?: SendFileOptions, cb?: (err?: Error) => void) => Response;
export {};
